...
animals = ["polar bear", "fox", "cheetah", "brown bear", "panda"]
...
movies = ["age of ultron", "endgame", "civil war"]
...
movie = input("Type a movie and see if it is in my movies list!: ")
if movie in movies:
    print("Yes, it is on my list!")
else:
    print("No, it is not on my list.")
...
words = input("Enter a random sentence: ")
for word in words:
    for c in word:
        print(" - " + c)
